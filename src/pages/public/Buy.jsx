...
export default function Buy() {
  ...
  const filteredProperties = useMemo(() => {
    return properties.filter((property) => {
      ...
      const priceMin = currentFilters.priceMin !== "" && currentFilters.priceMin !== undefined ? parsePrice(currentFilters.priceMin) : 0;
      const priceMax = currentFilters.priceMax !== "" && currentFilters.priceMax !== undefined ? parsePrice(currentFilters.priceMax) : Number.POSITIVE_INFINITY;
